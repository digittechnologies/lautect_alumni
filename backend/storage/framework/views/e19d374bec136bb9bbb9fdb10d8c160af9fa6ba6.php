        ...
        <div class="container">
            <div class="row">
                ...
                <div class="preheader-right">
                    ...
                    <?php else: ?>
                        <a title="Login" class="btn-auth btn-auth-rev" href="<?php echo e(route('login')); ?>">Login</a>
                        <a title="Register" class="btn-auth btn-auth" href="<?php echo e(route('register')); ?>">Signup</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
                    <!-- <div class="preheader-right">
