                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" id="register_name" name="name" value="<?php echo e(old('name')); ?>" placeholder="surname, firstname lastname" autofocus>
                                                            ...
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input  type="email" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" id="register_email" name="email" value="<?php echo e(old('email')); ?>" required>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="register_password" type="password" class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>" name="password" required>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="register_password" type="text" class="form-control<?php echo e($errors->has('faculty') ? ' is-invalid' : ''); ?>" name="faculty" required>
